    ...
    with log_execution_time("Submit Endpoint in main"):
        ...
        # Initialize response structure
            ...
            try:
                ...
                try:
                    relationships = find_relationships_for_tables(["Ponpure_LeadDetails","Ponpure_Schedules","Ponpure_Quotationhdrs","Ponpure_SaleOrderdtls","Ponpure_SaleorderHdrs","Ponpure_DispatchDetails"]  , 'table_relation.yaml')
